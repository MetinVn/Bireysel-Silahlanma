...
const GoDotFill = React.lazy(() =>
  import("react-icons/go").then((module) => ({ default: module.GoDotFill }))
);
    ...
    <div className="w-full bg-white">
      <div className="flex bg-[#a2d2ff] pt-9 w-full h-[200px] items-center max-h-[240px]">
        <div className="h-[120px] flex items-center mx-auto">
          <img
            src={photor}
            className="w-[100px] h-[100px] transform rotate-[-90deg]"
            alt="photo"
          />
        ...
        <div className='relative flex flex-col mx-auto min-h-[69px] max-w-[500px] min-w-[460px] p-5 font-["Arial"] bg-white shadow-lg shadow-black/30'>
          ...
          <div className="flex flex-row">
            ...
            <p className="text-[13px] leading-[14px] tracking-tighter font-semibold">
              Son zamanlarda hem dünyada hem de Türkiye{"'"}de şiddet
              davranışları birbirini taklit ederek toplumlarda yayılmaktadır.
              Çocuklar ve gençlerle ilgili şiddet haberleri giderek yaygın
              şiddet davranışları haline gelmekte ve ateşli silahların şiddet
