      ...
      <div className="flex bg-[#FDE83D] pt-9 w-full h-[100px] items-center max-h-[150px] md:h-[200px] md:max-h-[190px] lg:max-h-[240px] lg:h-full">
        <div className="h-[40px] md:h-[120px] flex items-center mx-auto lg:h-[240px]">
          <img
            ...
            alt="photo"
          />
          <div className="h-[30px] py-1 min-w-[3px] mx-[5px] md:h-[90px] md:py-2 md:min-w-[4px] md:mx-[12px] lg:py-5 lg:h-[130px] lg:min-w-[8px] bg-black lg:mx-5"></div>
        ...
        <div className='relative flex flex-col mx-auto min-h-[69px] sm:h-fit max-w-[170px] md:max-w-[360px] md:min-w-[280px] lg:max-w-[500px] lg:min-w-[460px] md:p-3 lg:p-5 font-["Arial"] bg-white shadow-lg shadow-black/30'>
          ...
          <div className="flex flex-row">
            ...
            <p className="text-[7px] leading-[7px] tracking-[-0.2px] md:text-[13px] lg:text-[14px] md:leading-[14px] lg:leading-[19px] md:tracking-tighter lg:tracking-tight font-semibold">
